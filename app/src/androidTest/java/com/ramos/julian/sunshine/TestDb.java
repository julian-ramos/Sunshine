...
public class TestDb extends AndroidTestCase {
    ...
    */
    static ContentValues createNorthPoleLocationValues(String testLocationSetting, String testCityName, double testLatitude, double testLongitude) {
    ...
    public void testLocationTable() {
        ...
        ContentValues testValues = createNorthPoleLocationValues(testLocationSetting,testCityName,testLatitude,testLongitude);
